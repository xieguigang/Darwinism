...
Namespace P2P
    ...
    Public Module GridProtocol
        ...
        Public Function CLI_InitStart(NodeEntry As String, Optional cli As CommandLine.CommandLine = Nothing) As Integer
            ...
            Using NodeClusterServices As New ClusterServices
                ...
                Else
                    ...
                    Using NodeServices As New NodeServices(IPAddress, NodeEntry, WanIP)
        ...
        ''' <returns></returns>
        Public Function CLI_StartCluster(cli As CommandLine.CommandLine, ByRef API As ClusterServices) As Integer
            Using NodeClusterServices As New ClusterServices
        ...
        Public Function CLI_InitStartNodeServices(IPAddress As String,
            ...
            Using NodeServices As New NodeServices(
            IPAddress,
            NodeEntry,
            WanIP)
                Call NodeServices.RunServices(Cli)
