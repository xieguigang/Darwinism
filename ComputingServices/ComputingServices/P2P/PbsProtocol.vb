...
#Region "NODE_REGISTER_TO_SERVICES"
        ...
        <Protocol(PROTOCOLS.NODE_REGISTER_TO_SERVICES)>
...
#Region "INIT_QUERY_SERVICES_ONLINE"
        ...
        <Protocol(PROTOCOLS.INIT_QUERY_SERVICES_ONLINE)>
...
#Region "SYNCHRONIZE_DATA"
        ...
        <Protocol(PROTOCOLS.SYNCHRONIZE_DATA)>
...
#Region "CURRENT_SERVICES_SHUTDOWN"
        ...
        <Protocol(PROTOCOLS.CURRENT_SERVICES_SHUTDOWN)>
...
#End Region
        ...
        Public Shared ReadOnly Property ProtocolCategory As Long =
            New Protocol(GetType(PbsProtocol)).EntryPoint
