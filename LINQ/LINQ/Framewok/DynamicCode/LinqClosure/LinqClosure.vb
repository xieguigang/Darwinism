#Region "Microsoft.VisualBasic::9a0709d97d0222b5867d6286286d41a4, ..\sciBASIC.ComputingServices\LINQ\LINQ\Framewok\DynamicCode\LinqClosure\LinqClosure.vb"
    ...
    Public Module LinqClosure
        ...
        Private Function __getProjects(source As IEnumerable(Of String)) As String
            ...
            Else
                ...
                Call anym.AppendLine(String.Join(", " & vbCrLf, projects.Select(Function(s) vbTab & __property(s)).ToArray))
