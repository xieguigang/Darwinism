#Region "Microsoft.VisualBasic::c34ff08ea281904bfc988631f70f5ac8, XDRStream\Writing\WriteMapper.vb"
...
Namespace Writing
    ...
    Public MustInherit Class WriteMapper
        ...
        Protected Sub Init()
            ...
            _builders.Add(OpaqueType.One, New Func(Of Type, [Delegate])() {AddressOf CreateEnumWriter, AddressOf CreateNullableWriter, AddressOf CreateLinkedListWriter, AddressOf EmitContext.GetWriter})
        ...
        Private Shared _tails As Byte()() = New Byte()() {Nothing, New Byte() {&H0}, New Byte() {&H0, &H0}, New Byte() {&H0, &H0, &H0}}
